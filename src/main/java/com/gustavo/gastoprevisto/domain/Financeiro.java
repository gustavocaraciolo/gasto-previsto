...
public class Financeiro implements Serializable {
    ...
    public Financeiro comprovantePagamento(byte[] comprovantePagamento) {
    ...
    public Financeiro comprovantePagamentoContentType(String comprovantePagamentoContentType) {
