...
public class Financeiro implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = "financeiros", allowSetters = true)
    private TipoFinanceiro financeiro;
    ...
    public TipoFinanceiro getFinanceiro() {
        return financeiro;
    }

    public Financeiro financeiro(TipoFinanceiro tipoFinanceiro) {
        this.financeiro = tipoFinanceiro;
        return this;
    }

    public void setFinanceiro(TipoFinanceiro tipoFinanceiro) {
        this.financeiro = tipoFinanceiro;
    }
