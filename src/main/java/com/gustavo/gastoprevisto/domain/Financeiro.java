...
public class Financeiro implements Serializable {
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "categoria_financeiro")
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = "financeiros", allowSetters = true)
    private TiposFinanceiro financeiro;
    ...
    public Financeiro categoriaFinanceiro(CategoriaFinanceiro categoriaFinanceiro) {
    ...
    public TiposFinanceiro getFinanceiro() {
        return financeiro;
    }

    public Financeiro financeiro(TiposFinanceiro tiposFinanceiro) {
        this.financeiro = tiposFinanceiro;
        return this;
    }

    public void setFinanceiro(TiposFinanceiro tiposFinanceiro) {
        this.financeiro = tiposFinanceiro;
    }
    ...
    public String toString() {
        return "Financeiro{" +
            ...
            ", categoriaFinanceiro='" + getCategoriaFinanceiro() + "'" +
            "}";
    }
}
