...
public class Propriedades implements Serializable {
    ...
    @Column(name = "dt_ass_contrato", precision = 21, scale = 2)
    private BigDecimal dtAssContrato;
    ...
    public BigDecimal getDtAssContrato() {
        return dtAssContrato;
    }

    public Propriedades dtAssContrato(BigDecimal dtAssContrato) {
        this.dtAssContrato = dtAssContrato;
        return this;
    }

    public void setDtAssContrato(BigDecimal dtAssContrato) {
        this.dtAssContrato = dtAssContrato;
    }
    ...
    public Propriedades anexo(Anexo anexo) {
        this.anexo = anexo;
        return this;
    }
