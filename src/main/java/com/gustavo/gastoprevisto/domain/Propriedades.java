...
public class Propriedades implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = "propriedades", allowSetters = true)
    private TipoFinanceiro propriedades;
    ...
    public TipoFinanceiro getPropriedades() {
        return propriedades;
    }

    public Propriedades propriedades(TipoFinanceiro tipoFinanceiro) {
        this.propriedades = tipoFinanceiro;
        return this;
    }

    public void setPropriedades(TipoFinanceiro tipoFinanceiro) {
        this.propriedades = tipoFinanceiro;
    }
