...
public class FinanceiroCriteria implements Serializable, Criteria {
    ...
    private LongFilter financeiroId;
    ...
    public FinanceiroCriteria(FinanceiroCriteria other) {
        ...
        this.financeiroId = other.financeiroId == null ? null : other.financeiroId.copy();
    ...
    public LongFilter getFinanceiroId() {
        return financeiroId;
    }

    public void setFinanceiroId(LongFilter financeiroId) {
    ...
    public boolean equals(Object o) {
        ...
        return
            ...
            Objects.equals(financeiroId, that.financeiroId) &&
    ...
    public String toString() {
        return "FinanceiroCriteria{" +
                ...
                (financeiroId != null ? "financeiroId=" + financeiroId + ", " : "") +
