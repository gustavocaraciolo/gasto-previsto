...
public class PropriedadesResource {
    ...
    public PropriedadesResource(PropriedadesRepository propriedadesRepository) {
    ...
    public ResponseEntity<Propriedades> createPropriedades(@RequestBody Propriedades propriedades) throws URISyntaxException {
        ...
        Propriedades result = propriedadesRepository.save(propriedades);
    ...
    public List<Propriedades> getAllPropriedades() {
    ...
    public ResponseEntity<Propriedades> getPropriedades(@PathVariable Long id) {
        ...
        Optional<Propriedades> propriedades = propriedadesRepository.findById(id);
