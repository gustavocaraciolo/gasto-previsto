...
public class FinanceiroResourceIT {
    ...
    public void createFinanceiro() throws Exception {
        ...
        assertThat(testFinanceiro.getComprovantePagamento()).isEqualTo(DEFAULT_COMPROVANTE_PAGAMENTO);
        assertThat(testFinanceiro.getComprovantePagamentoContentType()).isEqualTo(DEFAULT_COMPROVANTE_PAGAMENTO_CONTENT_TYPE);
    }
    ...
    public void updateFinanceiro() throws Exception {
        ...
        assertThat(testFinanceiro.getComprovantePagamento()).isEqualTo(UPDATED_COMPROVANTE_PAGAMENTO);
        assertThat(testFinanceiro.getComprovantePagamentoContentType()).isEqualTo(UPDATED_COMPROVANTE_PAGAMENTO_CONTENT_TYPE);
    }
