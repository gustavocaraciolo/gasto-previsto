...
public class FinanceiroResourceIT {
    ...
    public void getAllFinanceirosByTipoFinanceiroIsEqualToSomething() throws Exception {
        ...
        // Get all the financeiroList where tipoFinanceiro equals to DEFAULT_TIPO_FINANCEIRO
        defaultFinanceiroShouldBeFound("tipoFinanceiro.equals=" + DEFAULT_TIPO_FINANCEIRO);

        // Get all the financeiroList where tipoFinanceiro equals to UPDATED_TIPO_FINANCEIRO
        defaultFinanceiroShouldNotBeFound("tipoFinanceiro.equals=" + UPDATED_TIPO_FINANCEIRO);
    }

    @Test
    @Transactional
    public void getAllFinanceirosByTipoFinanceiroIsNotEqualToSomething() throws Exception {
        // Initialize the database
        financeiroRepository.saveAndFlush(financeiro);

        // Get all the financeiroList where tipoFinanceiro not equals to DEFAULT_TIPO_FINANCEIRO
        defaultFinanceiroShouldNotBeFound("tipoFinanceiro.notEquals=" + DEFAULT_TIPO_FINANCEIRO);

        // Get all the financeiroList where tipoFinanceiro not equals to UPDATED_TIPO_FINANCEIRO
        defaultFinanceiroShouldBeFound("tipoFinanceiro.notEquals=" + UPDATED_TIPO_FINANCEIRO);
    }

    @Test
    @Transactional
    public void getAllFinanceirosByTipoFinanceiroIsInShouldWork() throws Exception {
        // Initialize the database
        financeiroRepository.saveAndFlush(financeiro);

        // Get all the financeiroList where tipoFinanceiro in DEFAULT_TIPO_FINANCEIRO or UPDATED_TIPO_FINANCEIRO
        defaultFinanceiroShouldBeFound("tipoFinanceiro.in=" + DEFAULT_TIPO_FINANCEIRO + "," + UPDATED_TIPO_FINANCEIRO);

        // Get all the financeiroList where tipoFinanceiro equals to UPDATED_TIPO_FINANCEIRO
        defaultFinanceiroShouldNotBeFound("tipoFinanceiro.in=" + UPDATED_TIPO_FINANCEIRO);
    }

    @Test
    @Transactional
    public void getAllFinanceirosByTipoFinanceiroIsNullOrNotNull() throws Exception {
        // Initialize the database
        financeiroRepository.saveAndFlush(financeiro);

        // Get all the financeiroList where tipoFinanceiro is not null
        defaultFinanceiroShouldBeFound("tipoFinanceiro.specified=true");

        // Get all the financeiroList where tipoFinanceiro is null
        defaultFinanceiroShouldNotBeFound("tipoFinanceiro.specified=false");
    }
    ...
    @Test
    @Transactional
    public void getAllFinanceirosByPropriedadesIsEqualToSomething() throws Exception {
        // Initialize the database
        financeiroRepository.saveAndFlush(financeiro);
        Propriedades propriedades = PropriedadesResourceIT.createEntity(em);
        em.persist(propriedades);
        em.flush();
        financeiro.setPropriedades(propriedades);
        financeiroRepository.saveAndFlush(financeiro);
        Long propriedadesId = propriedades.getId();

        // Get all the financeiroList where propriedades equals to propriedadesId
        defaultFinanceiroShouldBeFound("propriedadesId.equals=" + propriedadesId);

        // Get all the financeiroList where propriedades equals to propriedadesId + 1
        defaultFinanceiroShouldNotBeFound("propriedadesId.equals=" + (propriedadesId + 1));
    }
